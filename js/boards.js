...
const TABULEIROS = [
  ...
  },
  {
    ...
    suspeitos: [
      { id: "alisson", nome: "Alisson", dica: "Ele estava exatamente uma fileira ao sul de alguém em uma bandeira.", foto: "assets/suspeitos/man_avatar.png", regraId: "estaUmaLinhaAoSulDeTipo", regraParams: { tipo: "bandeiraGolf" } },
      ...
      { id: "danielMinigolf", nome: "Daniel", dica: "Ele era a única pessoa em uma casa de trilha.", foto: "assets/suspeitos/brent.png", regraId: "estaSozinhoNoComodo2", regraParams: { comodo: "MINIGOLF TRILHA" } },
      { id: "eduarda", nome: "Eduarda", dica: "Ela estava em uma casa de areia.", foto: "assets/suspeitos/dolores.png", regraId: "estaNoComodo", regraParams: { comodo: "MINIGOLF AREIA" } },
      ...
      { id: "virginiaMinigolf", nome: "Virginia", dica: "A vítima. Ela estava sozinha com o assassino.", foto: "assets/suspeitos/dolores.png", isVitima: true, regraId: "semRestricao", regraParams: {} },
    ],
    pistasGerais: [

...
celulasBloqueadas: ["0-1","0-2","0-4","0-5","1-0","2-3","2-4","4-5","5-0","5-3","5-4","5-5"],
  ...
  },
  {
    ...
    gridInicial: [
      ...
      ["visitanteCamaBase", "vazio", "tapeteAzulLado", "vazio", "vazio", "vazio", "vazio", "tapeteAzulDobra", "visitanteCamaCoberta"],
      ["visitanteCamaCoberta", "vazio", "estante", "vazio", "visitanteTv", "vazio", "tapeteAzulBaixo", "vazio", "poltronaBranca"],
  ...
  },
  {
    ...
    gridInicial: [
      ["estante", "vazio", "vazio", "vazio", "vazio", "poltronaBranca", "mesaAzulComprida", "vazio"],
      ["vazio", "vazio", "vazio", "vazio", "visitanteTv", "vazio", "vazio", "poltronaBranca"],
      ["vazio", "estante", "mesaAzulComprida", "mesaAzulComprida", "mesaAzulComprida", "vazio", "vazio", "vazio"],
      ["vazio", "tapeteAzulDobra", "poltronaBranca", "tapeteAzulLado", "poltronaBranca", "tapeteAzulLado", "poltronaBranca", "mesaRoxa"],
      ["mesaRoxa", "poltronaBranca", "tapeteAzulBaixo", "vazio", "vazio", "vazio", "vazio", "vazio"],
      ["mesaRoxa", "tapeteAzulBaixo", "vazio", "visitanteTv", "vazio", "caixa", "vazio", "vazio"],
      ["vazio", "tapeteAzulBaixo", "tapeteAzulLado", "vazio", "vazio", "vazio", "vazio", "vazio"],
      ["estante", "tapeteAzulBaixo", "poltronaBranca", "poltronaBranca", "poltronaBranca", "visitanteTv", "poltronaBranca", "vazio"],
    ],
    ...
    comodos: [
      ...
      },
      {
        ...
        celulas: [
          ...celulasRetangulo(2, 2, 2, 4),
          ...celulasRetangulo(3, 0, 5, 4),
        ],
      },
      {
        nome: "ENTRADA",
        ...
        celulas: celulasRetangulo(2, 5, 5, 7),
      },
      {
        nome: "SALA DE ESPERA",
        cor: "#8c81c3",
    ...
    celulasBloqueadas: ["0-0","0-6","1-4","2-1","2-2","2-3","2-4","4-0","5-0","5-3","5-5","7-0","7-5"],
  ...
  },
  {
    ...
    gridInicial: [
      ...
      ["vazio", "poltronaBranca", "vazio", "mesaAreiaComprida", "visitanteCamaBase", "visitanteCamaCoberta", "vazio", "vazio", "vazio"],
      ...
      ["visitanteCamaBase", "poltronaBranca", "caixa", "vazio", "caixa", "vazio", "vazio", "caixa", "caixa"],
      ["vazio", "estante", "vazio", "vazio", "caixa", "vazio", "caixa", "estante", "vazio"],
    ],
    ...
    comodos: [
      ...
      },
      {
        ...
        celulas: celulasRetangulo(4, 0, 6, 2),
      },
      {
        nome: "QUARTO",
        cor: "#efcf94",
        rotulo: { left: 62, top: 54 },
        celulas: celulasRetangulo(4, 3, 6, 6),
      },
      {
        nome: "SALA SEGURA",
        cor: "#c8d4d6",
        rotulo: { left: 15, top: 96 },
        celulas: celulasRetangulo(7, 0, 8, 1),
      },
      {
        nome: "ESCADAS SECRETAS",
        cor: "#9eb0b5",
        rotulo: { left: 39, top: 84 },
        celulas: celulasRetangulo(7, 2, 8, 4),
      },
      {
        nome: "DESPENSA",
        cor: "#a9bdc3",
        ...
        celulas: celulasExceto(
          ...
          celulasRetangulo(4, 0, 6, 2),
          celulasRetangulo(4, 3, 6, 6),
          celulasRetangulo(7, 0, 8, 1),
          celulasRetangulo(7, 2, 8, 4)
        ),
      },
    ],
    ...
    celulasBloqueadas: ["1-1","1-2","1-7","2-0","2-1","2-3","2-6","2-8","3-6","4-3","5-2","5-3","5-7","5-8","6-0","6-1","6-2","6-5","6-6","7-2","7-4","7-7","7-8","8-1","8-4","8-6","8-7"],
  ...
  },
  {
    ...
    comodos: [
      ...
      },
      {
        ...
        celulas: celulasRetangulo(3, 0, 4, 3),
      },
      {
        nome: "SALA DE JANTAR",
        cor: "#9f81a2",
        rotulo: { left: 62, top: 50 },
        celulas: celulasRetangulo(3, 4, 4, 8),
      },
      {
        nome: "ADEGA",
        cor: "#8f7180",
        rotulo: { left: 50, top: 96 },
        celulas: celulasRetangulo(5, 0, 8, 6),
      },
      {
        nome: "PORÃO",
        cor: "#a07983",
        rotulo: { left: 86, top: 96 },
        celulas: celulasRetangulo(5, 7, 8, 8),
      },
    ],
  ...
  },
  {
    ...
    gridInicial: [
      ["vazio", "vazio", "vazio", "vazio", "vilaCactus", "vazio", "vazio", "mesaAreiaComprida", "mesaAreiaComprida", "flores"],
      ...
      ["vazio", "vazio", "vazio", "vazio", "vazio", "vazio", "vazio", "vazio", "vazio", "mesaAreiaComprida"],
      ["vazio", "vazio", "vazio", "vazio", "vazio", "vazio", "vazio", "mesaAreiaComprida", "mesaAreiaComprida", "mesaAreiaComprida"],
    ...
    comodos: [
      {
        nome: "O DESERTO",
        cor: "#f7f5a1",
        rotulo: { left: 11, top: 37 },
        celulas: [
          ...celulasRetangulo(1, 0, 2, 1),
          ...celulasRetangulo(3, 0, 5, 1),
        ],
      },
      {
        nome: "OS BARRIS",
        ...
        celulas: celulasRetangulo(3, 5, 5, 8),
      },
      {
        nome: "A ILHA",
        cor: "#a8e0e1",
        rotulo: { left: 26, top: 89 },
        celulas: [
          ...celulasRetangulo(6, 0, 7, 2),
          ...celulasRetangulo(8, 0, 9, 3),
        ],
      },
      {
        nome: "PASSARELA",
        cor: "#dad9c3",
        rotulo: { left: 50, top: 88 },
        celulas: celulasRetangulo(6, 4, 9, 5),
      },
      {
        nome: "ENTRADA",
        cor: "#d8d8ab",
        rotulo: { left: 73, top: 88 },
        celulas: celulasRetangulo(6, 6, 9, 9),
      },
      {
        nome: "CAMPO",
        cor: "#90cb76",
        ...
        celulas: celulasExceto(
          ...
          celulasRetangulo(3, 5, 5, 8),
          [
            ...celulasRetangulo(6, 0, 7, 2),
            ...celulasRetangulo(8, 0, 9, 3),
          ],
          celulasRetangulo(6, 4, 9, 5),
          celulasRetangulo(6, 6, 9, 9)
        ),
      },
    ],
